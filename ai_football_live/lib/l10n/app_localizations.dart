...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'No authorized stream available'**
  ...
  /// No description provided for @loadingLiveMatches.
  ///
  /// In en, this message translates to:
  /// **'Loading live matches...'**
  String get loadingLiveMatches;
  ...
  /// No description provided for @loadingMatch.
  ///
  /// In en, this message translates to:
  /// **'Loading match...'**
  String get loadingMatch;
  ...
  /// Shown when an assist is credited to a player
  ///
  /// In en, this message translates to:
  /// **'Assist: {player}'**
  String assistedBy(Object player);

  /// No description provided for @highValidation.
  ///
  /// In en, this message translates to:
  /// **'High confidence'**
  String get highValidation;
  ...
  /// No description provided for @lowValidation.
  ///
  /// In en, this message translates to:
  /// **'Low confidence'**
  String get lowValidation;
